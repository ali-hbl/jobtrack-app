...
JobTrack is an application tracking system designed as a Kanban board (similar to Trello or Jira), built specifically for developers looking for internships or jobs.
